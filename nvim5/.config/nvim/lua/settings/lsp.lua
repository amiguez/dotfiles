...
M.setup = function()
  ...
  lsp_config.sumneko_lua.setup({
    cmd = {
      -- MACOS ->>> "$HOME/Documents/lua-language-server/bin/macOS/lua-language-server",
      "/home/apollo/Documents/lua-language-server/bin/Linux/lua-language-server",
      "-E",
      "/home/apollo/Documents/lua-language-server/main.lua",
    },
    commands = {
      Format = {
        function()
